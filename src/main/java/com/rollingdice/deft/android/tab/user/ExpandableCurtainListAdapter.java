...
/**
 * Created by Rolling Dice on 6/3/2016.
 */
public class ExpandableCurtainListAdapter extends BaseExpandableListAdapter
{
    private Context context;
    private List<String> expandableListTitle;
    private HashMap<String, ArrayList<CurtainDetails>> expandableListDetail;


    private DatabaseReference localRef;

    public ExpandableCurtainListAdapter(Context context, List<String> expandableListTitle,
                                 HashMap<String, ArrayList<CurtainDetails>> expandableListDetail) {
    ...
    {
        try {
            final CurtainDetails expandedListText = (CurtainDetails) getChild(listPosition, expandedListPosition);
            if (convertView == null) {
            ...
            expandedListTextView.setText(expandedListText.getCurtainName());
        }catch (Exception e)
        {
