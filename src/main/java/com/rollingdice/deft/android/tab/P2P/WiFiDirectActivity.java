package com.rollingdice.deft.android.tab.P2P;
...
import com.rollingdice.deft.android.tab.P2P.DeviceListFragment.DeviceActionListener;
...
public class WiFiDirectActivity extends AppCompatActivity implements ChannelListener, DeviceActionListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar) findViewById(R.id.p2ptoolbar);
